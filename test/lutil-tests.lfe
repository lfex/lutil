...
(deftest uuid4
  ...
  (is-equal 36 (byte_size (lutil:uuid4 (tuple 'type 'strong 'bitstring))))
  (is-equal 288 (bit_size (lutil:uuid4 (tuple 'type 'strong 'bitstring))))
  (is (is_binary (lutil:uuid4 (tuple 'type 'strong 'bitstring))))
  (is-equal 16 (byte_size (lutil:uuid4 (tuple 'type 'binary))))
  (is-equal 128 (bit_size (lutil:uuid4 (tuple 'type 'binary))))
